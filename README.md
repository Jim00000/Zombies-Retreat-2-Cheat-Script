...
- No damage / full HP
- Auto machine gun fire (don't consume ammo)
- Maximum money
...
You should find "cheat is activated. Support Game Version: beta 0.23.1" message at screen's bottom of the game.

## User guide

Use F7 to open cheat panel.

![url of image is broken](https://hackmd.io/_uploads/ryrVnWP-T.png)
